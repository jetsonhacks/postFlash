...
# Add script to run at maximum performance
...
sudo sed -i 's/usb_port_owner_info=0/usb_port_owner_info=2/' /boot/extlinux/jetson-tk1_extlinux.conf.usb
# Disable USB autosuspend
sudo sed -i '$s/$/ usbcore.autosuspend=-1/'  /boot/extlinux/jetson-tk1_extlinux.conf.usb
